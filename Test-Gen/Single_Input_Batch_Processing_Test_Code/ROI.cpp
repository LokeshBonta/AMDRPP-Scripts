...
int main(int argc, char **argv)
{
    ...
    while (1)
    {
        roiPoints.x = rand() % srcSize[0].width; 
        roiPoints.y = rand() % srcSize[0].height; 
        roiPoints.roiHeight = (rand() % srcSize[0].height) * 3; 
        roiPoints.roiWidth = (rand() % srcSize[0].width) * 3; 
        roiPoints.roiHeight -= roiPoints.y; 
        roiPoints.roiWidth -= roiPoints.x;
        if((roiPoints.y + roiPoints.roiHeight > roiPoints.y && roiPoints.x + roiPoints.roiWidth > roiPoints.x) && (roiPoints.y + roiPoints.roiHeight < srcSize[0].height && roiPoints.x + roiPoints.roiWidth < srcSize[0].width))
            break;
    }
/* CODE BEGINS HERE */ 
